    ...
    public partial class Frm_Principal_Menu_UC : Form
    {
        ...
        private void Tbc_Aplicacoes_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Right)
            {
                ...
                ToolStripMenuItem vToolTip001 = DesenhaItemMenu("Deletar todas as abas", "DeleteAll");
                ToolStripMenuItem vToolTip002 = DesenhaItemMenu("Deletar abas a esquerda", "DeleteLeft");
                ToolStripMenuItem vToolTip003 = DesenhaItemMenu("Deletar abas a Direita", "DeleteRight");
                ToolStripMenuItem vToolTip004 = DesenhaItemMenu("Deletar Aba Atual", "DeleteTab");
